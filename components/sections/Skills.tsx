  ...
  return (
    ...
    >
      <div style={{ maxWidth: '1400px', margin: '0 auto', position: 'relative' }}>
        ...
        {/* Skill Columns (Cards) - Manual Masonry for Perfect Height Balance */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10 items-start">
          {/* Column 1 */}
          <div className="flex flex-col gap-8 lg:gap-10">
            {renderCategory(skillCategories[0], 0)} {/* Languages */}
            {renderCategory(skillCategories[2], 3)} {/* Data */}
          </div>
          
          {/* Column 2 */}
          <div className="flex flex-col gap-8 lg:gap-10">
            {renderCategory(skillCategories[1], 1)} {/* Backend */}
          </div>

          {/* Column 3 */}
          <div className="flex flex-col gap-8 lg:gap-10">
            {renderCategory(skillCategories[3], 2)} {/* DevOps */}
          </div>
        </div>
      </div>
    </section>
...
function renderCategory(cat: any, index: number) {
  const container = {
    hidden: {},
    show: { transition: { staggerChildren: 0.08 } },
  }
